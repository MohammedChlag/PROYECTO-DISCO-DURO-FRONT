        ...
        <header className={headerClasses}>
            ...
            {currentUser ? (
                ...
                <nav className="flex sm:space-x-4 text-xs sm:text-sm md:text-base">
                    <Link
                        className="hover:bg-gray-300 border-b-2 border-transparent hover:border-[#009EB5] p-1 rounded-md dark:text-white"
                        to="/users/register"
                    >
                        Registrarse
                    </Link>
                    <Link
                        to="/users/login"
                        className="hover:bg-gray-300 dark:text-white w-24 sm:w-28 md:w-32 border-b-2 border-transparent hover:border-[#009EB5] p-1 rounded-md"
                    >
                        Iniciar Sesión
                    </Link>
                </nav>
